 ...
 *
 * Run with:
 *   node --experimental-strip-types --test test/footer-state.test.mts
 */

import assert from "node:assert";
import { describe, it, beforeEach, afterEach, mock } from "node:test";
import type { ExtensionContext } from "@earendil-works/pi-coding-agent";
import { FooterState } from "../.pi/extensions/context-info/footer-state.ts";
import type { ContextStatusBarConfig } from "../.pi/extensions/context-info/types.ts";
