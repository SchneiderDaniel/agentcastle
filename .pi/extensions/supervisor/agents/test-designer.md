...
- When finished, output a JSON object with `"action": "COMPLETE", "agentName": "test-designer"` and your comment body (see Structured Output Format in your task). Fallback: if you cannot output JSON, output `TEST_PLAN_COMPLETE` on its own line
