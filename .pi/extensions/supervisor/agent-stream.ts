 ...
 * colors matching the message-renderer style. This gives the widget
 * the same look as pi's own message rendering while remaining live-updating.
 *
...
export function buildWidgetComponent(
	...
	// Show up to 50 recent log lines for decent scrollback in widget
